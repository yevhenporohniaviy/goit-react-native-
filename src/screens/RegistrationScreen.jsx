import {Text, View, StyleSheet, Pressable, ImageBackground, TouchableWithoutFeedback} from "react-native";
...
export default function Index() {
	...
	return (
		<ImageBackground style={register.imageBg} source={require('../../assets/images/bg_native.png')} resizeMode="cover">
			<View
				style={register.wrapper}
			>
